...
df2.to_csv("1000_arrival_times.csv")


n_electrolysers = 1000
n_canisters = 4000
...
for n in range(365):
    ...
    (demand, level, unsatisfied, at_one_time,) = get_optimised_electrolyser_demand(
        elec_price,
        dispenser_time_demand,
        starting_storage_level,
        electrolyser_capacity,
...
# df3 = pd.DataFrame(min_cost_array)
# df3.to_csv("1000_hydrogen_cost.csv")
