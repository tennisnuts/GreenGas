...
Change:
    changing the running for a year so that if it fails once it returns an ROI = 0
'''
...
#    Separate parameters
    ...
    def get_min_parameters(self, dispenser_time_demand):
        ...
        # running a while loop to get the minimum number of canisters and the minimum number of electrolysers
        # ----------------------------------------------------------------------------------------------------------
        self.min_n_electrolysers = number_electorlysers
        self.min_n_canisters = number_canisters
        
        self.min_electrolyser_capacity = 22.125*self.min_n_electrolysers
        self.min_storage_capacity = 9.5*self.min_n_canisters
        
    def run_year(self, dispenser_time_demand, electrolyser_capacity, storage_capacity):
        '''
        -------------------------------------------------------------------------------------------------------------
        run the system for 2020 price data
        '''
