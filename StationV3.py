...
Change:
    in V2 if the demand could not be met then the storage level would become negative, in this version the storage level cannot       become negative
    this also returns a number called unsatisfied to determine if the demand has been unsatisfied for optimistion
'''
